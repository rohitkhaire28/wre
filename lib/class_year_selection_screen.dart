...
import 'package:firstdemo/class_list_page.dart';

class ClassYearSelectionScreen extends StatelessWidget {
  final String branch;

  const ClassYearSelectionScreen({super.key, required this.branch});
          ...
          return _buildYearListItem(
            ...
            onTap: () {
              Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) => ClassListPage(branch: branch, year: year),
                ),
              );
            },
          );
