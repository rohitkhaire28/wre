...
import 'package:firstdemo/subject_list_page.dart';

class SubjectYearSelectionScreen extends StatelessWidget {
  final String branch;

  const SubjectYearSelectionScreen({super.key, required this.branch});
          ...
          return _buildYearListItem(
            ...
            onTap: () {
              Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) => SubjectListPage(branch: branch, year: year),
                ),
              );
            },
          );
