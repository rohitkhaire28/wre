...
import 'package:firstdemo/parent_year_selection_screen.dart';

class ParentBranchSelectionScreen extends StatelessWidget {
  const ParentBranchSelectionScreen({super.key});
      ...
      body: ListView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          return _buildBranchListItem(context, branch['name'] as String, branch['icon'] as IconData, branch['color'] as Color, () {
            Navigator.push(
              context,
              MaterialPageRoute(builder: (context) => ParentYearSelectionScreen(branch: branch['name'] as String)),
            );
          });
        },
      ),
