...
import 'package:firstdemo/class_year_selection_screen.dart';

class ClassBranchSelectionScreen extends StatelessWidget {
  const ClassBranchSelectionScreen({super.key});
      ...
      body: ListView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          return _buildBranchListItem(context, branch['name'] as String, branch['icon'] as IconData, branch['color'] as Color, () {
            Navigator.push(
              context,
              MaterialPageRoute(builder: (context) => ClassYearSelectionScreen(branch: branch['name'] as String)),
            );
          });
        },
      ),
