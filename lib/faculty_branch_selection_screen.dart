...
import 'package:firstdemo/faculty_list_page.dart';

class FacultyBranchSelectionScreen extends StatelessWidget {
  const FacultyBranchSelectionScreen({super.key});
      ...
      body: ListView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          return _buildBranchListItem(context, branch['name'] as String, branch['icon'] as IconData, branch['color'] as Color, () {
            Navigator.push(
              context,
              MaterialPageRoute(builder: (context) => FacultyListPage(branch: branch['name'] as String)),
            );
          });
        },
      ),
