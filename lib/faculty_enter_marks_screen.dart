...
import 'package:firstdemo/faculty_enter_marks_detail_screen.dart';

class FacultyEnterMarksScreen extends StatelessWidget {
          ...
          return SubjectCard(
            ...
            onTap: () {
              Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) => FacultyEnterMarksDetailScreen(
